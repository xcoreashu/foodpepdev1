...
<div className="form-group">
    <label for="formGroupExampleIn">Serach for restaurants</label>
    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Please Enter your name and land to the best restaurants nearby" />
    </div>
    </form>
      <h2 className = "heading-des"> Our Top Tie Up Restaurnats</h2>
